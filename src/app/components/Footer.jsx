      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.linkedin.com/company/reeorg" className="text-gray-400 hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/#features" className="text-gray-300 hover:text-white transition-colors">Workforce Intelligence</Link></li>
              <li><Link href="/#skills-dashboard" className="text-gray-300 hover:text-white transition-colors">Talent Management</Link></li>
              <li><Link href="/#features" className="text-gray-300 hover:text-white transition-colors">Skills Intelligence</Link></li>
        ...
        <div className="border-t border-gray-800 pt-8">
          <p className="text-gray-400 text-sm text-center">
            &copy; 2025 ReeOrg. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
