...
export default function SkillsSection() {
  return (
    <section id="skills-dashboard" className="py-24 bg-gradient-to-br from-blue-50 to-indigo-50">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2 relative">
            <div className="relative">
              ...
              {/* Floating elements */}
              <div className="absolute -top-6 -right-6 bg-white rounded-xl shadow-lg p-4 border border-gray-100 animate-float">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-sm font-semibold text-gray-900">Risk Alert</div>
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-lg p-4 border border-gray-100 animate-float animation-delay-2000">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-sm font-semibold text-gray-900">New Hire</div>
